...
Promise.all([
  faceapi.nets.ssdMobilenetv1.loadFromUri("http://localhost/Face-Recognition-Attendance-System-main/Lecture/models"),
  faceapi.nets.faceRecognitionNet.loadFromUri("http://localhost/Face-Recognition-Attendance-System-main/Lecture/models/"),
  faceapi.nets.faceLandmark68Net.loadFromUri("http://localhost/Face-Recognition-Attendance-System-main/Lecture/models/"),
]).then(() => {
  modelsLoaded = true;
});
